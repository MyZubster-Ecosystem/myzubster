...
- **#022 — Public Ecosystem Status Console** — canonical evidence → bounded public snapshot by world state, adoption stage and source type; status projection is not system health.

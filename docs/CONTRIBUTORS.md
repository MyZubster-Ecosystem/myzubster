...
|---|---|---|---|---|
| `@Aming9303` | Frontend / dashboard / visual documentation / IoT sensing | PR #531; PR #634; PR #859 | all `OPEN / SUBMITTED`; #859 is a bounded LIFE #534 contribution | #534 sensing adapter **active public LIFE contribution**; #537 dashboard & KPI evidence; evidence UX / visualization |
...
A clear public contribution on one of these bounded issues may establish contributor-work opt-in for that task. It is **not** participant-profile consent, partnership, employment or external payment authorization.

## Evidence rules

Valid evidence may include issue links, pull requests, commits, reproducible tests, review records and public documentation contributions.

...
const UserSchema = new mongoose.Schema({
  ...
  githubAutomation: { enabled: { type: Boolean, default: false }, consentedAt: { type: Date }, updatedAt: { type: Date }, writeAuthorizedAt: { type: Date }, accessTokenEncrypted: { type: String, select: false }, previousName: { type: String, trim: true, maxlength: 180 }, previousBio: { type: String, trim: true, maxlength: 160 }, previousReadme: { type: String, maxlength: 50000 }, previousReadmeExisted: { type: Boolean }, lastPublishedName: { type: String, trim: true, maxlength: 180 }, lastPublishedBio: { type: String, trim: true, maxlength: 160 }, lastPublishedReadme: { type: String, maxlength: 50000 } },

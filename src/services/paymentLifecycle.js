const PAYMENT_STATES = Object.freeze({ PENDING: 'PENDING', SUBMITTED: 'SUBMITTED', CONFIRMED: 'CONFIRMED', FAILED: 'FAILED', CANCELLED: 'CANCELLED' });
const ALLOWED_TRANSITIONS = Object.freeze({ PENDING: ['SUBMITTED', 'FAILED', 'CANCELLED'], SUBMITTED: ['CONFIRMED', 'FAILED', 'CANCELLED'], CONFIRMED: [], FAILED: ['SUBMITTED', 'CANCELLED'], CANCELLED: [] });

  ...
  try {
    ...
    if (bounty) {
      ...
      bounty = new BountyConfig({
        ...
        paymentAsset: process.env.MYZ_PAYMENT_ASSET || components[0].asset,
        paymentNetwork: process.env.MYZ_PAYMENT_NETWORK || components[0].network || 'Tari'
      });
      await bounty.save();
    }
    res.json({

...
| `MyZubster-Robot`, `MyZubster-App`, `MyZubsterGateway`, `MyZubsterWeb`, `tokenization-singapore`, `my-monero-bounty` — multi-repository aggregate | `SourceProofLabs` | **1.673 XMR reported across 28 merged PRs** | **PENDING INDEPENDENT RECONCILIATION / UNSETTLED** | None published | Contributor claim preserved from [`myzubster#530` comment 5490974465](https://github.com/MyZubster-Ecosystem/myzubster/issues/530#issuecomment-5490974465). Aggregate conservatively counts `MyZubsterGateway#56` at 0.01 XMR and excludes the disputed 0.05 XMR difference unless reconciled. No funding reservation or payment is asserted. |

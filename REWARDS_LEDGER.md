...
|---|---|---:|---|---|---|---|
| `myzubster#566` / PR `#602` — Signed identity credential design | `Aming9303` | 2,500 MYZ | **VERIFIED** — approved after security hardening and merged | **REWARD_RECORDED** — `MYZ-LEDGER-000002` | **NOT VERIFIED** | Internal MYZ credit recorded in `myz/ledger.json`; provenance: `docs/bounties/ID-BNT-0003-VERIFICATION.md`. This does not imply cash, blockchain transfer or other external settlement. |

...
function DiscoverableRooms({ rooms, linked }) {
  return (
    <section className="metaverse-panel">
      ...
      {linked && <p><a className="metaverse-primary" href="/metaverse/rooms/new">Crea una stanza</a></p>}
